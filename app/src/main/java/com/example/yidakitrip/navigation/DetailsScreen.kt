...
import com.example.yidakitrip.navigation.graph.Ars
...
sealed class DetailsScreen(val route: String) {
    ...
    object LessonDetailed: DetailsScreen(route = "lesson_detailed_screen/{${Ars.LESSON_DETAILED_ARGUMENT_KEY}}/{${Ars.LESSON_DETAILED_ARGUMENT_KEY2}}") {
        fun passId(
            id: Int,
            name: String
        ): String {
